#!/usr/bin/env python3
"""
Test script for the enhanced FIFA 2026 chatbot functionality.
Tests the new specialized query functions and text-to-SQL capabilities.
"""
...
def run_tests():
    ...
    print("🚀 Starting FIFA 2026 Chatbot Tests")
